export default {
  ...
  work: {
    svitanak: {
      ...
      description: 'Здесь я стал работать по распределению сразу после колледжа. Работа заключалась в автоматизации разных процессов в рамках крупного швейного производство. В основном я помогал отделам маркетинга, финансов и общежитий, писал для них прикладной софт на Delphi 7. Сэкономил людям кучу времени. Первое время я работал с энтузиазмом, но вскоре стало ясно, что государственное предприятие не заинтересовано в толковых специалистах, и я просто смотрел сериалы и занимался своими делами. Уволился, потому что надоело рано вставать и мерзнуть в плохо отапливаемом помещении.',
    },
    itgarant: {
