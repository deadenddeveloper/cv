export default {
	...
	skills: {
		...
		js:
			'Знание JavaScript (plain JS, jQuery‚ Vue.js/Vuex/Nuxt.js, Alpine, Svelte, React, Electron, Node/Express), TypeScript',
		...
		environment:
			'Опыт установки и настройки окружения для веб-разработки (Homestead, PHP, MySQL, Apache, Nginx) на Windows и Unix.',
