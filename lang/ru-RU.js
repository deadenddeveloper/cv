export default {
  ...
  work: {
    ...
    vke: {
      time: 'Сентябрь 2021 - по настоящее время',
      post: 'Full stack web-разработчик',
      firm: 'von Kéler Engineering GmbH',
      location: 'Брауншвейг, Германия',
      description: 'Стал частью команды веб-разработчиков. Поначалу занимался внутренними проектами компании, а потом делал интересную штуку на React внутри Electron.',
    },
  },
