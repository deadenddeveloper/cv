export default {
  ...
  work: {
    ...
    recoma: {
      time: 'Июль 2018 - по настоящее время',
      post: 'Full stack web-разработчик',
      firm: 'RECO.MA GmbH',
      location: 'Безелих, Германия',
      description: 'Получил предложение переехать в Германию и не раздумывал. Сейчас делаю несколько крупных и амбициозных проектов на Laravel, параллельно обслуживаю пару сайтиков на Wordpress и пишу кастомные пользовательские интерфейсы.',
    },
  },
